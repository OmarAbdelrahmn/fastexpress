                ...
                <div className="h-72" dir="ltr">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={vTypes} layout="vertical" margin={{top: 0, right: 30, left: 20, bottom: 5}}>
                      ...
                      <Legend />
                      <Bar dataKey="available" stackId="a" fill="#10b981" radius={[0, 0, 0, 0]} name={t('dashboardTabs.logistics.available')} />
                      <Bar dataKey="taken" stackId="a" fill="#3b82f6" radius={[0, 4, 4, 0]} name={t('dashboardTabs.logistics.taken')} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
             </div>
                ...
                <div className="h-72" dir="ltr">
                   <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={countries} layout="vertical" margin={{top: 0, right: 30, left: 30, bottom: 5}}>
                        ...
                        <Tooltip cursor={{fill: '#f3f4f6'}} contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} />
                        <Legend />
                        <Bar dataKey="employeeCount" stackId="a" fill="#06b6d4" radius={[0, 0, 0, 0]} name={t('dashboardTabs.demographics.employees')} />
                        <Bar dataKey="riderCount" stackId="a" fill="#8b5cf6" radius={[0, 4, 4, 0]} name={t('dashboardTabs.demographics.riders')} />
                      </BarChart>
                   </ResponsiveContainer>
                </div>
             </div>
