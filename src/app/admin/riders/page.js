...
export default function RidersPage() {
  ...
  const handleExportExcel = () => {
    ...
    const data = filteredRiders.map(rider => ({
      ...
      [t('employees.excelColumns.sponsor')]: rider.sponsor || '',
      [t('employees.excelColumns.sponsorNo')]: rider.sponsorNo || '',
      [t('employees.excelColumns.birthDate')]: rider.dateOfBirth ? rider.dateOfBirth.split('T')[0] : '',
    ...
    data.push({
      ...
      [t('riders.workingId')]: '',
      [t('riders.company')]: '',
      [t('employees.excelColumns.sponsor')]: '',
      [t('employees.excelColumns.sponsorNo')]: '',
      [t('employees.excelColumns.birthDate')]: '',
      [t('riders.housing')]: '',
