...
import { Package, Search, History, ArrowRight, User, Plus, Trash2, FileText } from 'lucide-react';
...
export default function MemberRiderAccessoriesPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await ApiService.post(`${API_ENDPOINTS.MEMBER.RIDER_ACCESSORIES.RECORD_USAGE}?date=${dateParam}`, requestBody);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-row items-center justify-center gap-4 px-4 md:px-6">
                ...
                <Button
                    variant="outline"
                    onClick={() => router.push('/member/maintenance/usage-history?tab=accessories')}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        {usageEntries.map((entry, index) => (
                            <div key={index} className="p-3 md:p-4 border-2 border-gray-200 rounded-lg">
