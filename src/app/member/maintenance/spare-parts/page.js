...
export default function MemberSparePartsPage() {
    ...
    const [usageEntries, setUsageEntries] = useState([
        { sparePartId: '', vehicleNumber: '', selectedVehicle: null, quantityUsed: 1 }
    ]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await ApiService.post(`${API_ENDPOINTS.MEMBER.SPARE_PARTS.RECORD_USAGE}?date=${dateParam}`, requestBody);
