...
export default function VehicleFixProblemPage() {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            {/* Page Header */}
            <div>
                <h3 className="text-lg md:text-2xl font-bold text-gray-900">إصلاح مشكلة حقيقية</h3>
                            ...
                            {filteredVehicles.map((vehicle) => (
                                ...
                                >
                                    <div className="flex items-center justify-between gap-2 mb-2">
                                        ...
                                        <span className="text-[10px] md:text-xs px-2 py-1 rounded-full font-medium bg-red-100 text-red-700">
