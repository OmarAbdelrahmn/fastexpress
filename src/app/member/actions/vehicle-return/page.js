...
export default function VehicleReturnRequestPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.reason.trim()) {
            setMessage({ type: "error", text: "يرجى إدخال سبب الإرجاع" });
            return;
        }
        ...
        try {
            ...
            await ApiService.post(API_ENDPOINTS.MEMBER.VEHICLE_REQUEST_RETURN, payload);

            setMessage({
                type: "success",
                text: "تم إرسال طلب إرجاع المركبة بنجاح"
            });
                    ...
                    <div className="mb-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
                            />
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={handleInputChange}
                            placeholder="اذكر سبب إرجاع المركبة (مثل: انتهاء الدوام، تغيير مركبة، مشكلة في المركبة، إلخ)"
                            rows="4"
                    ...
                    <div className="flex justify-end pt-4 border-t border-gray-100">
                        <button
                            ...
                            className="flex items-center gap-2 px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
                                <>
