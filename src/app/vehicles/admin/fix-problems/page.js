...
import { Wrench, AlertTriangle, CheckCircle, Car, Clock, User } from 'lucide-react';
  ...
  const handleFixProblem = async (e) => {
    ...
    try {
      await ApiService.post(
        `/api/vehicles/fix-problem?plate=${selectedVehicle.plateNumberA}&reason=${encodeURIComponent(fixReason)}`
      );
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-orange-100">إدارة وإصلاح المركبات التي بها مشاكل</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-blue-700">
                {problemVehicles.reduce((sum, v) => sum + (v.problemsCount || 0), 0)}
              </p>
            </div>
            ...
            {problemVehicles.map((vehicle) => (
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center gap-2 text-gray-600">
                    <Clock size={14} />
                    <span>منذ: {new Date(vehicle.since).toLocaleDateString('ar-SA')}</span>
                  </div>
          ...
          <form onSubmit={handleFixProblem} className="space-y-6">
            <div className="bg-green-50 border-r-4 border-green-500 p-4 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-green-800 mb-1">إصلاح المشكلة</h3>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-orange-600">{selectedVehicle.problemsCount}</p>
                </div>
              </div>
            </div>
