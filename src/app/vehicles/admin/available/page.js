...
import { CheckCircle, Search, Car, MapPin, Calendar, Info, Eye } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-green-50 border-r-4 border-green-500 p-5 rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-green-600 mb-1">إجمالي المتاحة</p>
      ...
      <Card>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">لا توجد مركبات متاحة</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="space-y-2 text-sm mb-4">
                  ...
                  {vehicle.manufacturer && (
                    <div className="flex items-center gap-2 text-gray-700">
                      <Info size={14} />
                      <span className="text-xs">{vehicle.manufacturer} - {vehicle.manufactureYear || 'N/A'}</span>
                    </div>
                  )}
                  ...
                  {vehicle.licenseExpiryDate && (
                    <div className="flex items-center gap-2 text-gray-700">
                      ...
                      <span className="text-xs">
                        انتهاء الرخصة: {new Date(vehicle.licenseExpiryDate).toLocaleDateString('ar-SA')}
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="font-bold text-green-800 mb-3">المعلومات الأساسية</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{selectedVehicle.manufacturer || 'غير محدد'}</p>
                    </div>
                    <div>
                      <p className="text-gray-600 mb-1">سنة الصنع</p>
                      <p className="font-medium text-gray-800">{selectedVehicle.manufactureYear || 'غير محدد'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{selectedVehicle.ownerName || 'غير محدد'}</p>
                    </div>
                    <div>
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="font-medium text-gray-800">
                        {selectedVehicle.licenseExpiryDate 
                          ? new Date(selectedVehicle.licenseExpiryDate).toLocaleDateString('ar-SA')
                          : 'غير محدد'}
                      </p>
                    </div>
                  </div>
