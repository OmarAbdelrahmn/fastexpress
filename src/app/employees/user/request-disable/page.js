...
export default function RequestDisableEmployeePage() {
  ...
  if (data) {
    ...
    if (employee.status === 'disable') {
      setErrorMessage('هذا الموظف غير نشط بالفعل');
      return;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage('تم إرسال طلب التعطيل بنجاح. في انتظار موافقة المسؤول.');
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="إرسال طلب لتعطيل موظف نشط"
        icon={UserX}
        actionButton={{
          text: 'العودة',
      ...
      <div className="bg-red-50 border-r-4 border-red-500 p-4 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-red-800 mb-1">تحذير</h3>
            <p className="text-sm text-red-600">
              طلب التعطيل سيقوم بتغيير حالة الموظف إلى "غير نشط" عند الموافقة عليه من قبل المسؤول.
            </p>
          </div>
        </div>
      </div>
      ...
      <Card>
        ...
        <div className="bg-blue-50 p-3 rounded-lg">
          <p className="text-sm text-blue-700">
            ابحث عن الموظف النشط الذي تريد طلب تعطيله
          </p>
        </div>
      </Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  سبب طلب التعطيل <span className="text-red-500">*</span>
                </label>
                <textarea
                  value={reason}
                  ...
                  required
                  rows={4}
                  placeholder="اذكر السبب التفصيلي لطلب تعطيل هذا الموظف..."
              ...
              <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg">
                <p className="text-sm text-yellow-700">
                  <strong>ملاحظة:</strong> يجب توضيح السبب بشكل دقيق لأن هذا الطلب سيتطلب موافقة المسؤول
                </p>
              </div>
            </div>
          </Card>
        ...
        <Card>
          ...
          <div className="space-y-3 text-sm text-gray-600">
            <div className="flex items-start gap-2">
              ...
              <p>ابحث عن الموظف النشط برقم الإقامة</p>
            </div>
            <div className="flex items-start gap-2">
              <div className="bg-blue-100 p-1 rounded mt-0.5">
            ...
            <div className="flex items-start gap-2">
              ...
              <p>أدخل اسمك وسبب طلب التعطيل بشكل واضح</p>
            </div>
            <div className="flex items-start gap-2">
              <div className="bg-blue-100 p-1 rounded mt-0.5">
