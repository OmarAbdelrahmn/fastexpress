...
const pathTranslationKeys = {
  ...
  "admin/vehicles": "vehicles.dashboard",
  ...
  "admin/vehicles/with-riders": "vehicles.vehiclesWithRidersTitle",
  "admin/vehicles/take": "vehicles.takeVehicle",
  "admin/vehicles/return": "vehicles.returnVehicle",
  "admin/vehicles/manage": "navigation.manageVehicles",
  "admin/vehicles/change-location": "vehicles.changeLocation",
  "admin/vehicles/users-requests": "vehicles.supervisorRequests",
  "admin/vehicles/problems": "vehicles.reportProblem",
  "admin/vehicles/fix-problems": "vehicles.fixProblems",
  "admin/vehicles/stolen": "vehicles.stolenVehicles",
  "admin/vehicles/recover-stolen": "vehicles.recoverStolen",
  "admin/vehicles/breakup": "vehicles.breakUpVehiclesTitle",
  "admin/vehicles/out-of-service": "vehicles.outOfService",
  "admin/vehicles/switch": "vehicles.switchVehicle",
  "admin/vehicles/details": "vehicles.vehicleDetails",
  ...
  "admin/maintenance/money-spending": "مركز تكلفة قطع الغيار و معدات السائقين",
