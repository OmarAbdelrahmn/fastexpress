...
const styles = StyleSheet.create({
    ...
    // Colors per column
    colHousing: { width: '22%', backgroundColor: '#b91c1c' },
    colTotal: { width: '23%', backgroundColor: '#0000cc' },
    colAvg: { width: '25%', backgroundColor: '#a3e635' },
    colActive: { width: '15%', backgroundColor: '#fbbf24' },
    colPerc: { width: '15%', backgroundColor: '#06b6d4' },
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerRight}>
                        ...
                        <View style={styles.dateRow}>
                            <Text style={styles.dateLabel}>الفترة:</Text>
                            <Text style={styles.dateValue}>{formatDate(data.startDate)} - {formatDate(data.endDate)}</Text>
                        </View>
                    </View>
                ...
                <View style={styles.footerSection}>
                    ...
                    {/* Average Orders per Rider Overall */}
                    <View style={styles.footerRow}>
                        <Text style={styles.footerLabel}>متوسط طلبات المندوب</Text>
                        <View style={styles.footerValueBox}>
                            <View style={styles.valueContainer}>
                                <Text style={styles.valueText}>{data.averageOrdersPerRider}</Text>
                            </View>
                            <Text style={styles.unitText}>طلب</Text>
                        </View>
                    </View>
...
export default Special7ReportPDF;
