...
const KetaDailySummaryTemplate = ({ data }) => {
    ...
    return (
        <div id="keta-daily-summary-print" className="hidden print:block bg-white w-full h-full p-4 font-sans" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            {/* Header */}
            <div className="flex justify-between items-start mb-8 border-b-2 border-dashed border-gray-400 pb-4">
                {/* Title Section */}
                <div className="flex flex-col items-start gap-4">
                    <div className="p-2 bg-white">
                        <h1 className="text-xl font-bold text-[#1e3a8a]">{t('keta.daily.title')}</h1>
                    </div>
            ...
            <div className="grid grid-cols-2 gap-6">
                <div className="border border-gray-300 rounded-lg p-6 bg-green-50">
                    <h3 className="text-lg font-bold text-gray-600 mb-2">{t('keta.daily.totalDelivered')}</h3>
                ...
                {/* <div className="border border-gray-300 rounded-lg p-6 bg-orange-50">
                    <h3 className="text-lg font-bold text-gray-600 mb-2">{t('keta.daily.avgWorkingHours')}</h3>
                ...
                <div className="border border-gray-300 rounded-lg p-6 bg-red-50">
                    <h3 className="text-lg font-bold text-gray-600 mb-2">{t('keta.daily.totalRejected')}</h3>
                ...
                <div className="border border-gray-300 rounded-lg p-6 bg-purple-50">
                    <h3 className="text-lg font-bold text-gray-600 mb-2">{t('keta.daily.totalRiders')}</h3>
