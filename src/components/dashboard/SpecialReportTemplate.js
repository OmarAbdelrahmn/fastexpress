...
const SpecialReportTemplate = ({ data }) => {
    ...
    return (
        <div id="special-report-print" className="hidden print:block bg-white w-full h-full p-8 font-sans" dir="rtl">
           {/* Simple Header */}
           <div className="bg-blue-600 text-white px-8 py-5 mb-10 rounded-lg shadow-lg flex items-center justify-between">
            ...
            <div className="grid grid-cols-3 gap-10 max-w-6xl mx-auto">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="bg-gray-400 text-white py-4 px-6 text-2xl font-bold w-full text-center rounded-lg shadow-lg">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="bg-gray-400 text-white py-4 px-6 text-2xl font-bold w-full text-center rounded-lg shadow-lg mb-10">
                        {data.ordersDifference}
                    </div>

                    <div className="bg-orange-400 text-white py-4 px-6 text-2xl font-bold w-full text-center rounded-lg shadow-lg">
