export const navigationConfig = {
  ...
  reports: {
    ...
    routes: [
      ...
      { path: "/reports/custom-range", label: "تقارير مخصصة" },
      { path: "/reports/company-performance", label: "أداء الشركة" },
      { path: "/reports/compare-company", label: "مقارنة الشركات" },
      { path: "/reports/riders", label: "تقارير المناديب" },
      { path: "/reports/compare-riders", label: "مقارنة المناديب" },
      { path: "/reports/housing", label: "تقارير السكن" },
      { path: "/reports/housing-compare", label: "مقارنة السكنات" },
      { path: "/reports/top-riders", label: "أفضل المناديب" },
      { path: "/reports/top-riders-monthly", label: "أفضل المناديب شهرياً" },
      { path: "/reports/top-riders-yearly", label: "أفضل المناديب سنوياً" },
      { path: "/reports/top-riders-company", label: "أفضل المناديب بالشركة" },
      { path: "/reports/problems", label: "تقارير المشاكل" },
      { path: "/reports/stacked", label: "التوصيلات المكدسة" },
    ],
  },
