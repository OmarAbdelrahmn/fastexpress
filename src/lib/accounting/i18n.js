...
const translations = {
  ar: {
    ...
    status: {
      ...
      needsresolution: 'تحتاج إلى معالجة',
...
const optionTranslations = {
  ...
  Failed: 'فشل الاستيراد', Informational: 'معلوماتي', Inactive: 'غير نشط', NeedsResolution: 'تحتاج إلى معالجة',
  Paid: 'مدفوع', Parsing: 'جاري التحليل', Pending: 'قيد الانتظار', Prepared: 'مجهز',
  Received: 'تم الاستلام', Reconciled: 'تمت المطابقة', Rejected: 'مرفوضة', Retired: 'موقوف',
  Submitted: 'مرسل للمراجعة', Superseded: 'تم استبدالها', Approved: 'معتمدة', Allowance: 'بدل', Bonus: 'مكافأة',
