...
export const API_ENDPOINTS = {
  ...
  REPORTS: {
    ...
    COMPARE_RIDER_PERIODS: (workingId) =>
      `/api/report/riders/compare/${workingId}`,
    COMPARE_RIDER_MONTHLY: (workingId) =>
      `/api/report/riders/compare-monthly/${workingId}`,
    COMPARE_RIDER_YEARLY: (workingId) =>
      `/api/report/riders/compare-yearly/${workingId}`,
